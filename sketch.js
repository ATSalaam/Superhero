...
function setup() {
  ...
  box11 = new Box(750, 100, 140, 70);
  box12 = new Box(750, 100, 140, 70);
  box13 = new Box(750, 100, 140, 70);
  box14 = new Box(750, 100, 140, 70);
  box15 = new Box(750, 100, 140, 70);
...
function imgChange(){
  if(monster.y === 550){
    ...
    monsterImg = loadImage("monster2.png");
  }
}